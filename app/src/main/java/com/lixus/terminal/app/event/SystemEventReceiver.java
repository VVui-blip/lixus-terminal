...
import com.lixus.terminal.app.boot.BootScriptRunner;
...
public class SystemEventReceiver extends BroadcastReceiver {
    ...
    public synchronized void onActionBootCompleted(@NonNull Context context, @NonNull Intent intent) {
        ...
        // Built-in Termux:Boot equivalent: run user scripts from ~/.termux/boot/
        BootScriptRunner.runBootScripts(context);
    }
